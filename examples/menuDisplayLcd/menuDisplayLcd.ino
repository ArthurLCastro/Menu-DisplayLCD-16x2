// Menu de navegação com Display LCD 16x2 e 3 pushbuttons
// Arthur L. Castro
// Junho de 2019
...
#define BUT_ENTER   7         // Pino para botão de selecao
#define BUT_RIGHT   8         // Pino para botão de navegação para a direita

#define BUZZER_PIN  9         // Pino para botão de selecao
